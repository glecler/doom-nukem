...
int ft_choose_texture(int button, int x, int y, t_editor_data *e_data)
{
...
t_link_list *ft_selected_link(t_editor_data *e_data)
{
    t_link_list *link;
...
int ft_assign_tex(t_link_list *link, t_editor_data *e_data)
{
