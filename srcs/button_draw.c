...
int ft_button_draw_mode_left_click_none(int x, int y, t_editor_data *e_data, int type)
{
...
int ft_button_draw_mode_left_click(int x, int y, t_editor_data *e_data, int type)
{
    if (e_data->draw_state == DRAW_NONE && x > 0 && y > 42)
        ft_button_draw_mode_left_click_none(x, y, e_data, type);
...
int ft_button_draw_top(int button, int x, int y, t_editor_data *e_data)
{
    if (button == 1)
