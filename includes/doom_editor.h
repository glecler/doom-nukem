...
int				ft_big_pixel_img(char *addr, t_node node, unsigned char *rgb,
	t_e_data *e_data);
int				ft_put_pixel_img(char *addr, int x, int y, unsigned char *rgb);
void			ft_put_line_vert(t_node a, t_node b, char *addr,
	t_e_data *data);
...
int				ft_button_draw_mode_wall(int button, int x, int y,
	t_e_data *e_data);
int				ft_button_draw_mode_floor(int button, int x, int y,
	t_e_data *e_data);
int				ft_button_draw_mode_top(int button, int x, int y,
	t_e_data *e_data);
...
int				ft_but_d_mode_lft_clkn(int x, int y, t_e_data *e_data,
	int type);
...
int				ft_button_select_mode(int button, int x, int y,
	t_e_data *e_data);
...
int				ft_button_erase_mode(int button, int x, int y,
	t_e_data *e_data);
...
int				ft_button_link_second_node(t_e_data *e_data,
	t_node_list *buff, int type);
int				ft_button_link_mode_top(int button, int x, int y,
	t_e_data *e_data);
int				ft_button_link_mode_wall(int button, int x, int y,
	t_e_data *e_data);
int				ft_button_link_mode_floor(int button, int x, int y,
	t_e_data *e_data);
...
int				ft_node_from_node(t_node_list *node, t_node_list *goal,
	t_e_data *e_data);
...
int				ft_triangle_from_node_top(t_node_list *node, int vertex,
	t_e_data *e_data, int no[4]);
...
int				ft_button_mod_z_none(int x, int y, int button,
	t_e_data *e_data);
...
int				ft_delete_link_type(t_link_list *link, t_link_list *buff,
	t_llist *llist);
...
int				ft_delete_4_links(t_link_list *link, t_link_list *buff,
	t_llist *llist);
int				ft_delete_5_links(t_link_list *link, t_link_list *buff,
	t_llist *llist);
int				ft_delete_3_links(t_link_list *link, t_link_list *buff,
	t_llist *llist);
int				ft_delete_1_links(t_link_list *link, t_link_list *buff,
	t_llist *llist);
int				ft_delete_2_links(t_link_list *link, t_link_list *buff,
	t_llist *llist);
